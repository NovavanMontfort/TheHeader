      ...
      <div class="grid flex flex-nowrap">
        <div class="col-1-1 flex flex-nowrap sm-align-center">
          <div class="flex flex-nowrap align-center">
            ...
            >
              <DotLottieVue
                v-if="effectiveHeaderColor === 'color-white'"
                autoplay
                loop
                :src="'/lottie-animation/logo-white.json'"
                class="logo-img"
              />
              <DotLottieVue
                v-else-if="effectiveHeaderColor === 'color-black'"
                autoplay
                loop
                :src="'/lottie-animation/logo-black.json'"
                class="logo-img"
              />
            </NuxtLink>
          </div>
...
const homeLink = computed(() => {
  return multiLanguageStore.currentLanguage === 'nl' ? '/' : '/en';
});
...
const navItems = computed(() => {
  return navigation.value.filter((item) => item.url && item.id !== 4);
});
