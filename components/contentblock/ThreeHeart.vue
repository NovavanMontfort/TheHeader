...
import heartModelPath from "~/assets/heart/the_heart.glb?url";
import hdrPath from "~/assets/heart/lighting.hdr?url";

const heartModelUrl = heartModelPath;
const hdrUrl = hdrPath;
